...
namespace Omegastore.Ecommerce.Services.WebApi.Controllers.v2
{
    [Authorize]
    ...
    public class CustomerController : Controller
    {
        ...
        {
            var _customerDto = _customerApplication.Get(customerId);
            if (_customerDto.Data == null)
            {
                return NotFound(_customerDto.Message);
            }
            if (customerDto == null)
            {
                return BadRequest();
